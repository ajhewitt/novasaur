%{
/* This is the XR18NO machine description file for the 1802 next generation compiler.
...
//incaddr: ADDI2(reg,acon)  "'O',R%0,(%1)" range(1,1,1)
//reg: incaddr  "\tldA2 R%c,%0; reg:incaddr\n"  2
...
reg: ADDI2(reg,consm) "?\tcpy2 R%c,R%0\n\tincm R%c,%1\n"  1
...
reg: CVUI2(reg)  "?\tcpy1 R%c,R%0\n\tzExt %c ;CVUI2(reg): widen unsigned char to signed int (zero extend)*\n"    1
...
%%
static void progend(void){
		print(	"\tinclude lcc1802EpiloNO.inc\n"
			"\tinclude IO1802.inc\n");
...
static void progbeg(int argc, char *argv[]) {
        ...
        time_t now;
        struct tm* ptmNow;
        static char rev[] = "$Version: 3.0 - XR18NO - The St. Patrick's Day Compiler $";
	...
	fprintf(stderr,"After three days we reached land, and for twenty-eight.317.3 days journeyed through uninhabited country...\n");  //just so I know who's playing
        time(&now);
...
Interface xr18noIR = {	//each entry represents size, alignment, out-of-line literals needed
        1, 1, 0,  /* char */
        2, 1, 0,  /* short */
        2, 1, 0,  /* int */
        4, 4, 0,  /* long jan 20*/

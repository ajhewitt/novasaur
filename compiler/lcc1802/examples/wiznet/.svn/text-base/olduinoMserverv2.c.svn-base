...
unsigned int numslots=3; //how many ip address slots i have
unsigned int nextslot=0; //what is the next one to use
union IPaddr regip[3]={1,2,3};//the ips i have registered
union IPaddr cmdip={182};
char cmdname[16];
union IPaddr thisip={182}; //the ip a form/request came from
unsigned char regname[3][16]={0}; //registered name/country
int pagehits=0;
char strbuf[16];
struct SPIsequence{

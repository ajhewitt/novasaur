/*
	...
	Aug 13, 2014 trying character printing
*/
#include <olduino.h>
#include <nstdlib.h>
...
void pingerholder(){ //dummy function read an ultrasonic ping distance sensor
...
void main()
{
	char buff[8]; //buffer for ascii conversion
 	...
 	//digitalWrite(LcdSS,HIGH); //cycle the LCD slave

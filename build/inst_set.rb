DST = %w[N E1 E2 E3 E4 E5 E6 E7 X E S V Y HL PC PG]
SRC = %w[I IZ E EZ I IZ E EZ A AZ D1 D1Z A AZ D0 D0Z]
ALU = %w[MV ADD SUB AS AND OR XOR DPG MUL DIV SYS AUD VID PS2 FNE FNF]

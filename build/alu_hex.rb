...
IDLE_PG = 0x00
INST = [
  0x86,1, 0x8D,1, 0x97,1, 0xA9,1, 0xA5,2, 0xA7,2, 0x8B,1, 0xB9,1, # 0x00X
  0xD9,2, 0xAB,2, 0x96,1, 0xAA,1, 0xA5,2, 0xA7,2, 0x8B,1, 0xBA,1,
  0x87,1, 0x8D,1, 0x97,1, 0xA9,1, 0xA5,2, 0xA7,2, 0x8B,1, 0xBB,2, # 0x01X
  0xC9,2, 0xAB,2, 0x96,1, 0xAA,1, 0xA5,2, 0xA7,2, 0x8B,1, 0xBC,2,
  0xD7,2, 0x8D,1, 0x93,3, 0xA9,1, 0xA5,2, 0xA7,2, 0x8B,1, 0xAC,2, # 0x02X
  0xDA,1, 0xAB,2, 0x90,3, 0xAA,1, 0xA5,2, 0xA7,2, 0x8B,1, 0xBD,1,
  0xD8,2, 0x8D,1, 0x8F,2, 0xA9,1, 0xA6,2, 0xA8,2, 0x8C,2, 0xBF,1, # 0x03X
  0xDB,1, 0xAB,2, 0x8E,2, 0xAA,1, 0xA5,2, 0xA7,2, 0x8B,1, 0xBE,1,
  0x89,1, 0x89,1, 0x89,1, 0x89,1, 0x89,1, 0x89,1, 0x8A,1, 0x89,1, # 0x04X
  0x89,1, 0x89,1, 0x89,1, 0x89,1, 0x89,1, 0x89,1, 0x8A,1, 0x89,1,
  0x89,1, 0x89,1, 0x89,1, 0x89,1, 0x89,1, 0x89,1, 0x8A,1, 0x89,1, # 0x05X
  0x89,1, 0x89,1, 0x89,1, 0x89,1, 0x89,1, 0x89,1, 0x8A,1, 0x89,1,
  0x89,1, 0x89,1, 0x89,1, 0x89,1, 0x89,1, 0x89,1, 0x8A,1, 0x89,1, # 0x06X
  0x89,1, 0x89,1, 0x89,1, 0x89,1, 0x89,1, 0x89,1, 0x8A,1, 0x89,1,
  0x89,1, 0x89,1, 0x89,1, 0x89,1, 0x89,1, 0x89,1, 0x88,1, 0x89,1, # 0x07X
  0x89,1, 0x89,1, 0x89,1, 0x89,1, 0x89,1, 0x89,1, 0x8A,1, 0x89,1,
  0x99,1, 0x99,1, 0x99,1, 0x99,1, 0x99,1, 0x99,1, 0x9A,1, 0x99,1, # 0x08X
  0x9C,1, 0x9C,1, 0x9C,1, 0x9C,1, 0x9C,1, 0x9C,1, 0x9D,2, 0x9C,2,
  0x9F,1, 0x9F,1, 0x9F,1, 0x9F,1, 0x9F,1, 0x9F,1, 0xA0,1, 0x9F,1, # 0x09X
  0xA2,2, 0xA2,2, 0xA2,2, 0xA2,2, 0xA2,2, 0xA2,2, 0xA3,2, 0xA2,2,
  0xAD,1, 0xAD,1, 0xAD,1, 0xAD,1, 0xAD,1, 0xAD,1, 0xAE,1, 0xAD,1, # 0x0AX
  0xB3,1, 0xB3,1, 0xB3,1, 0xB3,1, 0xB3,1, 0xB3,1, 0xB4,1, 0xB3,1,
  0xB0,1, 0xB0,1, 0xB0,1, 0xB0,1, 0xB0,1, 0xB0,1, 0xB1,1, 0xB0,1, # 0x0BX
  0xB6,1, 0xB6,1, 0xB6,1, 0xB6,1, 0xB6,1, 0xB6,1, 0xB7,1, 0xB6,1,
  0xC6,2, 0xCB,2, 0xC1,1, 0xC0,2, 0xC3,2, 0xCD,2, 0x9B,2, 0xC8,1, # 0x0CX
  0xC7,2, 0xC6,2, 0xC1,1, 0xC2,1, 0xC4,2, 0xC3,2, 0x9E,2, 0xC8,1,
  0xC6,2, 0xCB,2, 0xC1,1, 0xD3,2, 0xC3,2, 0xCD,2, 0xA1,2, 0xC8,1, # 0x0DX
  0xC7,2, 0xC5,2, 0xC1,1, 0xD2,2, 0xC4,2, 0x01,1, 0xA4,2, 0xC8,1,
  0xC6,2, 0xCB,2, 0xC1,1, 0xD0,3, 0xC3,2, 0xCD,2, 0xAF,2, 0xC8,1, # 0x0EX
  0xC7,2, 0xCA,1, 0xC1,1, 0x98,2, 0xC4,2, 0x02,2, 0xB5,2, 0xC8,1,
  0xC6,2, 0xCC,2, 0xC1,1, 0xD6,1, 0xC3,2, 0xCE,2, 0xB2,2, 0xC8,1, # 0x0FX
  0xC7,2, 0xD1,1, 0xC1,1, 0xD5,1, 0xC4,2, 0x03,3, 0xB8,2, 0xC8,1

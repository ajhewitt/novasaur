...
SHMRD   EQU     18DDH   ;SHARED MEM READ BYTE
SHMWR   EQU     19DDH   ;SHARED MEM WRITE BYTE
DMA     EQU     12DDH   ;DMA
;
...
DPBLA:	;DISK PARAMETER BLOCK, COMMON TO ALL DISKS
        ;RAM 250K DISK: 8 SEC x 250 TRX @2K BLOCKS
...
DPBLB:	;DISK PARAMETER BLOCK, COMMON TO ALL DISKS
        ;ROM 60K DISK: 4 SEC x 120 TRX @1K BLOCKS
	...
	DW	8		;TRACK OFFSET
;
DPBLC:	;DISK PARAMETER BLOCK, COMMON TO ALL DISKS
        ;MAX 8M DISK: 256 SEC x 256 TRX @4K BLOCKS
...
GOCPM:
        MVI	A, 0C3H		;C3 IS A JMP INSTRUCTION
	STA	3CH		;FOR JMP TO RELOC
	LXI	H, RELOC	;RELOC ENTRY POINT
	SHLD	3DH		;SET ADDRESS FIELD FOR JMP AT 3C
;
...
PUNCH:	;PUNCH CHARACTER FROM REGISTER C
        ;ONLY SEND BUFFER IF A==0
        ;SEND IF SIZE>A|127, Z-FLAG SET IF ALL SENT
        ORA     A               ;A==0?
        JZ      SENDER          ;FLUSH BUFFER
        LXI     H, BUFFWR
        MOV     B, M            ;B=WR
        INR     M               ;WR+1
        MVI     H, BUFF>>8
...
SELDSK:	;SELECT DISK GIVEN BY REGISTER C
	...
	MOV	A, C
	CPI	2		;MUST BE BETWEEN 0 AND 3 (V1.0 0-1)
	RNC			;NO CARRY IF 4, 5,...
	PUSH    A
	CPI     1               ;B: DRIVE?
	CZ      WRTPRTD         ;YES: WRITE PROTECT
	POP     A
...
;
; 72 BYTES LEFT FOR BIOS CODE
;
;	THE REMAINDER OF THE CBIOS IS RESERVED UNINITIALIZED
;	DATA AREA, AND DOES NOT NEED TO BE A PART OF THE
;	SYSTEM MEMORY IMAGE (684 BYTES MUST BE AVAILABLE,
...
ALL00	EQU	BEGDAT	 	;ALLOCATION VECTOR 0
ALL01	EQU	ALL00+31 	;ALLOCATION VECTOR 1
ALL02	EQU	ALL01+31	;ALLOCATION VECTOR 2
ALL03	EQU	ALL02+31	;ALLOCATION VECTOR 3
CHK00	EQU	ALL03+31	;CHECK VECTOR 0
;CHK01	EQU	CHK00+16	;CHECK VECTOR 1 - B:FIXED
CHK02	EQU	CHK00+16	;CHECK VECTOR 2
CHK03	EQU	CHK02+16	;CHECK VECTOR 3
;
DIRBF	EQU	CHK03+16 	;SCRATCH DIRECTORY AREA
BUFF	EQU	DIRBF+17Fh&0FF00h;B:DRIVE/TX/RX BUFFER
ENDDAT  EQU     BUFF+1FFH
